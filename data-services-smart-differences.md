# Smart data/services.js DOC-vs-code differences

Instruction labels such as TAGLINE, FAQ QUESTION, FAQ ANSWER, CHANGE HEADING, NOTE, and design/layout notes are not treated as website content. When a label contains desired copy, only the copy after the label is compared.

Total code content entries not exactly matching cleaned DOC content: 603
...
## Line 17 `description`
DOC says:
> No matching website-copy line found in DOCX
...
CODE has:
> Plans that cover you wherever your lifestyle takes you.
...
CODE has:
> One plan to secure the health of your entire family.
...
CODE has:
> How does No Claim Bonus benefit me"

Match score: 0.231

## Line 40 `answer`
DOC says:
> 4. Long-Term Security: Get coverage for claims arising even after treatment, as per policy terms.
...
## Line 44 `question`
DOC says:
> Can I transfer my Motor Insurance Policy?
...
CODE has:
> Yes, you can enhance your sum insured at renewal.
...
## Line 93 `description`
DOC says:
> What are the types of Traditional Life Insurance Plans?
...
CODE has:
> Built to handle evolving healthcare costs.

Match score: 0.125

## Line 106 `answer`
DOC says:
> 3. Can the policy be extended?Yes, it can be extended for project delays or to include maintenance period cover.
...
CODE has:
> Is there a waiting period in Health Super Top-Up plans"
...
DOC says:
> 3. Family Security Assured: Financial protection for your loved ones with added returns. 4. Financial Discipline: Build a habit of saving while staying protected.
...
## Line 155 `description`
DOC says:
> 1. Employee Protection: Ensure financial support for employees in case of workplace injuries or accidents.
...
DOC says:
> 2. Medical & Disability Benefits: Cover medical expenses, disability compensation and loss of income support.
...
## Line 205 `tagline`
DOC says:
> So That Healing Never Demands Dismantling Your Legacy
...
DOC says:
> End-To-End Coverage For Materials, Works and On-Site Risks
...
## Line 326 `title`
DOC says:
> Life Cover with the Added Benefit of Premium Return
...
## Line 340 `description`
DOC says:
> Ensuring Confidence in Your Profession with Financial Protection.
...
## Line 346 `description`
DOC says:
> Reliable Protection for Your Taxi and Your Livelihood
...
## Line 362 `question`
DOC says:
> What is the ideal Term Insurance cover I should have?
...
## Line 394 `description`
DOC says:
> 3. Are SIP returns guaranteed?No, returns are market-linked as mutual funds invest in equity, debt or other instruments. However, long-term investing improves the potential for stable returns.
...
CODE has:
> Wealth Switching Flexibility

Match score: 0.125

## Line 406 `description`
DOC says:
> No matching website-copy line found in DOCX
...
## Line 410 `title`
DOC says:
> Co-Creation of Wealth - Win-Win Only
...
## Line 427 `question`
DOC says:
> What is the minimum investment required in E-Gold?
...
CODE has:
> Can I partially withdraw from ULIP"
...
CODE has:
> Your vehicles — whether cherished classics or trusted everyday drives — are more than mere conveyances. They reflect taste, independence and a lifestyle carefully cultivated. Our Motor Insurance solutions go far beyond basic compliance. We find tailored covers that account for true market value, zero depreciation concerns and seamless repair or replacement — so every drive remains a pleasure, never a preoccupation. From accidental damages to theft and liability, we ensure you are shielded from life’s unforeseen detours. Because with the right protection, your journeys can stay focused on joy — not just risk.

Match score: 0.425

## Line 524 `description`
DOC says:
> This add-on ensures full claim settlement without deducting depreciation on parts, leading to higher claim payouts.

CODE has:
> Full claim amount without deduction for depreciation.

Match score: 0.222

## Line 529 `description`
DOC says:
> Reliable Protection for Your Taxi and Your Livelihood

CODE has:
> 24x7 support for breakdowns and emergencies.

Match score: 0.182

## Line 534 `description`
DOC says:
...
## Line 540 `description`
DOC says:
> Drive with Confidence, Insured Every Mile
...
CODE has:
> Exploring the world — be it for business negotiations in London or leisurely summers in the Bahamas — brings unparalleled joy. Yet travel also carries the occasional turbulence: misplaced luggage, unexpected illness or sudden disruptions. With finely attuned global coverage, we ensure these inconveniences never escalate into financial or emotional burdens — so your plans proceed unhindered and your mind stays at ease. From emergency evacuations to hotel cancellations, we safeguard every leg of your itinerary. So, you can immerse fully in new cultures and experiences, knowing we are quietly managing the ‘what ifs.’

Match score: 0.385

## Line 588 `description`
DOC says:
> End-To-End Coverage For Materials, Works and On-Site Risks

CODE has:
> Coverage for hospitalization and treatment abroad.
...
CODE has:
> Reimbursement for non-refundable bookings.
...
## Line 598 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Compensation for lost or delayed checked-in baggage.
...
CODE has:
> How is the claim settled in Travel Insurance"
...
## Line 619 `question`
DOC says:
> 3. Can tenants buy Home Insurance?

CODE has:
> Can senior citizens buy Travel Insurance"
...
## Line 718 `description`
DOC says:
> 3. Multi-Risk Protection: Coverage against accidents, fire, theft and third-party liability.
...
CODE has:
> Who should consider Fire & Burglary Insurance"
...
## Line 734 `question`
DOC says:
> 3. Does this policy cover regulatory penalties?

CODE has:
> Does this policy cover both building and contents"

Match score: 0.4

## Line 735 `answer`
DOC says:
> 3. Contents Protection: Covers furniture, fixtures and equipment inside the shop.
...
CODE has:
> What is not covered under Fire & Burglary Insurance"

Match score: 0.5

## Line 740 `answer`
DOC says:
> 4. What is not covered under this policy?Normal wear and tear, mechanical or gradual deterioration of machinery, intentional damage are usually excluded.
...
## Line 763 `title`
DOC says:
> Protecting Your Workforce, Securing Your Business
...
CODE has:
> Seamless Cross-Border Protection

Match score: 0.2

## Line 771 `description`
DOC says:
> Ensuring Confidence in Your Profession with Financial Protection.
...
## Line 775 `title`
DOC says:
> Enabling Confident Business Growth With Credit Risk Protection
...
## Line 804 `question`
DOC says:
> What is a co-payment in Group Health Insurance?
...
## Line 956 `description`
DOC says:
> 4. Financial Safeguard: Protect your business from unexpected compensation payouts and liabilities.
...
## Line 1005 `tagline`
DOC says:
> Financial Security Against Unforeseen Professional Risks.

CODE has:
> Financial Protection Against Accidental Risks

Match score: 0.375

## Line 1006 `description`
DOC says:
...
DOC says:
> 2. Asset Replacement Support: Ensures quick repair or replacement of damaged items.
...
CODE has:
> Why do companies offer Group Term Life Insurance"
...
CODE has:
> Protect Your Employees with Comprehensive Group Health Insurance

Match score: 0.375

## Line 1137 `description`
DOC says:
> Group Health Insurance is a health insurance policy purchased by an employer to provide medical coverage to employees and in many cases, their family members. Instead of individual policies, a single master policy covers the entire workforce, offering affordable and comprehensive healthcare protection.
...
CODE has:
> Cashless & Day-One Benefits

Match score: 0.118

## Line 1155 `description`
DOC says:
> No matching website-copy line found in DOCX
...
CODE has:
> Access World-Class Healthcare Services at the Tap of a Button

Match score: 0.143

## Line 1203 `description`
DOC says:
...
CODE has:
> 24x7 Support When the Unexpected Happens on the Road

Match score: 0.2

## Line 1268 `description`
DOC says:
...
## Line 1334 `tagline`
DOC says:
> Protecting Your Practice, Reputation and Peace of Mind

CODE has:
> Protect Your Ride and Ride with Peace of Mind

Match score: 0.455

## Line 1335 `description`
DOC says:
...
## Line 1341 `description`
DOC says:
> 4. Is depreciation considered in claims?

CODE has:
> Coverage in case your bicycle is stolen.

Match score: 0.2

## Line 1344 `title`
DOC says:
> 1. Does it cover damage during office relocation?
...
## Line 1346 `description`
DOC says:
> 1. Legal Liability Cover: Protection against legal expenses arising from accidents.
...
CODE has:
> Veterinary Expense Support

Match score: 0.1

## Line 1411 `description`
DOC says:
...
## Line 1423 `description`
DOC says:
> 4. Can I insure multiple taxis under one policy?
...
## Line 1566 `answer`
DOC says:
> It depends on factors such as Doctor’s specialization (higher risk = higher cover), Years of experience and patient volume.
...
## Line 1601 `description`
DOC says:
> ICONS1. Dual Benefit Plan: Insurance + savings combined in one smart solution. 2. Money Back Assurance: Get back all premiums paid at maturity with life cover protection.

CODE has:
> Insurance and savings combined in one smart solution.

Match score: 0.28

## Line 1629 `answer`
DOC says:
> 2. When will I receive the premium back?The premium is returned at the end of the policy term (maturity) if no claim has been made.
...
## Line 1639 `answer`
DOC says:
> No, ROP returns are up to premium paid and do not account for inflation impact over time.
...
## Line 1659 `description`
DOC says:
> In today’s digital world, risks like online fraud, hacking, phishing and identity theft are increasing rapidly. It protects you against financial losses arising from unauthorized transactions, cyber scams and data breaches.

CODE has:
> In today’s digital world, risks like online fraud, hacking, phishing and identity theft are increasing rapidly. Personal Cyber Insurance protects you against financial losses arising from unauthorized transactions, cyber scams and data breaches. It also offers support for data restoration, cyber extortion, legal expenses and reputation management—ensuring complete protection for you and your family in the digital space.

Match score: 0.612

## Line 1723 `description`
DOC says:
...
CODE has:
> With rising cyber threats like data breaches, ransomware and hacking, businesses face serious financial and reputational risks. Corporate Cyber Insurance protects your organization against losses from cyber incidents, including data theft, business interruption, legal liabilities and recovery costs. It also provides expert support for incident response, ensuring minimal disruption and faster recovery.

Match score: 0.711

## Line 1753 `answer`
DOC says:
> 1. Who should buy this policy?Businesses of all sizes especially those handling customer data, digital payments, online platforms or sensitive information should opt for Corporate Cyber Insurance to protect against cyber risks and financial losses.
...
## Line 1759 `answer`
DOC says:
> 2. What is First-Party and Third-Party Corporate Cyber Insurance coverage?First-party Corporate Cyber Insurance covers your own losses (data recovery, business interruption) , while Third-party Corporate Cyber Insurance covers liabilities to customers due to data breaches.
...
## Line 1874 `description`
DOC says:
> 4. Add-On Benefits: Options like zero depreciation, engine protection and return to invoice and more.
...
## Line 1896 `answer`
DOC says:
> It excludes wear and tear of the vehicle, mechanical breakdown, driving without a valid license, driving under the influence of alcohol and use outside permitted purpose.
...
## Line 1915 `description`
DOC says:
> This insurance provides financial protection for your home and personal assets against risks like fire, theft, natural disasters and accidental damage. It covers both the structure of your house and its contents, ensuring that you are safeguarded from unexpected financial losses. With flexible coverage options and add-ons, Home Insurance helps you secure your most asset while offering peace of mind and long-term financial stability.
...
## Line 1931 `title`
DOC says:
> Is Health Assistance affordable?
...
## Line 1933 `description`
DOC says:
> 3. Tax Efficiency Withdraw smartly with potential tax advantages compared to traditional income options.
...
## Line 2063 `description`
DOC says:
> 1. Project Shield: Smart risk management for contractors and developers. 2. Construction Cover: Covering unforeseen risks at every stage of construction. 3. Financial Security: Prevents unexpected project losses. 4. End-to-End Coverage: Covers development, testing & commissioning phases.

CODE has:
> Covers development, testing and commissioning phases.

Match score: 0.194

## Line 2069 `answer`
DOC says:
> It is not legally mandatory, but is often required by project contracts, banks and financial institutions, government and large infrastructure projects
...
## Line 2120 `description`
DOC says:
> 1. Installation Security: Covers risks during assembly and setup.2. Workforce Safety Support: Covers third-party risks involving workers. 3. Industrial Project Essential: Ideal for factories, plants & heavy installations. 4. Business Continuity: Ensures projects stay on track financially.

CODE has:
> Ideal for factories, plants and heavy installations.

Match score: 0.219

## Line 2165 `description`
DOC says:
...
## Line 2198 `answer`
DOC says:
> 2. Is Export Business covered under this policy?Yes, Export Trade can be covered, including risks like political instability or currency restrictions subject to policy terms and conditions.
...
## Line 2237 `title`
DOC says:
> 2. Can the policy cover multiple devices?

CODE has:
> Multiple Equipment Cover

Match score: 0.286

## Line 2239 `description`
DOC says:
> 4. Can I insure multiple taxis under one policy?
...
## Line 2245 `description`
DOC says:
> 4. Reconstruction Support: Covers the cost of rebuilding or repairing your home or a pre-agreed insured value.
...
## Line 2267 `answer`
DOC says:
> Coverage may lapse unless the insurer is informed and policy is updated for the new location.
...
## Line 2324 `answer`
DOC says:
> A Surety Bond is a guarantee with risk assessment by insurer, while a bank guarantee involves blocking funds or credit limits in a bank.
...
## Line 2384 `answer`
DOC says:
> E&O Insurance covers professional mistakes or service errors while, General Liability covers physical injury or property damage.
...
## Line 2394 `answer`
DOC says:
> 3. Is E&O Insurance mandatory?Not always mandatory, but often required in contracts or by regulatory bodies in certain professions.
...
## Line 2509 `answer`
DOC says:
> Premium depends on the various factors like number and type of vehicles, usage (private/commercial), claims history of the fleet, geographical location, coverage opted and add-ons.
...
## Line 2649 `answer`
DOC says:
> It depends on the policy type, some offer replacement value, others consider depreciation.
...
## Line 2672 `tagline`
DOC says:
> Because Steady Compounding Is Built on Discipline, Not Impulse
...
## Line 2679 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Funds selected to match specific financial goals.
...
## Line 2684 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Portfolios tailored to your risk tolerance.
...
## Line 2708 `answer`
DOC says:
> Systematic Investment Plan (SIP) allows you to invest a fixed amount regularly (daily/monthly/quarterly), promoting disciplined investing and rupee cost averaging.
...
## Line 2773 `answer`
DOC says:
> 2. Can I increase my SIP amount later?Yes, you can increase your SIP through a step-up option as your income grows or during the tenure of SIP also.
...
## Line 2783 `answer`
DOC says:
> 4. How do I choose the right SIP?The best SIP for you depends on your goals, risk level and how long you want to invest. Our expert advice help you to makes it easier to choose the right funds and stay on track.
...
## Line 2879 `description`
DOC says:
> 2. Risk Management: Gradually shifts investments from low-risk to high-growth funds to balance stability and returns or vice-versa.
...
## Line 2885 `description`
DOC says:
> 3. Flexibility of Amount: Allows customization of transfer value and frequency.
...
## Line 2938 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Continuous review and rebalancing of investments.
...
## Line 2943 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Designed to match specific investment objectives.

Match score: 0.167

## Line 2946 `title`
DOC says:
> Smarter Strategies For Smarter Capital
...
## Line 2948 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Invests across multiple strategies.
...
## Line 2953 `description`
DOC says:
> 2. Valuable Items Cover: Optional protection for jewellery and high-value possessions.

CODE has:
> Built for complex and high-value portfolios.
...
CODE has:
> Building Calm Amidst the Clamor

Match score: 0.111

## Line 2993 `description`
DOC says:
...
CODE has:
> In a world that often rewards speed and speculation, some investors prefer the quiet dignity of certainty. Bonds offer precisely this—capital preservation paired with predictable income, creating a foundation upon which aspirations can securely rest. Navigating thousands of bond issuances—each with distinct ratings, coupon structures and market dynamics—requires more than a glance at yield tables. We evaluate credit histories, macro-economic overlays and your personal liquidity map to curate options that serve both immediate and intergenerational needs. Our advisory also manages demat allocations, monitors coupon flows and assists with maturity reinvestment—turning fixed income into a quietly compounding ally.

Match score: 0.466

## Line 2999 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Focus on safety of principal.

Match score: 0.125

## Line 3004 `description`
DOC says:
> No matching website-copy line found in DOCX
...
## Line 3062 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> High-conviction bets on specific themes or sectors.
...
## Line 3097 `question`
DOC says:
> How transparent are ULIPs?

CODE has:
> How are returns generated in PMS"
...
## Line 3124 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Participate in PE, VC and private credit deals.

Match score: 0.133

## Line 3127 `title`
DOC says:
> Are Bond returns fixed?
...
## Line 3129 `description`
DOC says:
> Are Stock Market Investments risky?

CODE has:
> Performance often independent of stock market moves.
...
## Line 3134 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Long-short, arbitrage and other hedge fund strategies.
...
## Line 3156 `answer`
DOC says:
> 3rd QUESTION ANSWER- AIFs are broadly classified into: Category I – Venture Capital, Startups, Infrastructure, Social Ventures, Category II – Private Equity, Debt Funds and Category III – Hedge Funds and Complex Trading Strategies.

CODE has:
> AIFs are broadly classified into: Category I – Venture Capital, Startups, Infrastructure, Social Ventures Category II – Private Equity, Debt Funds Category III – Hedge Funds and complex trading strategies
...
CODE has:
> Why consider AIFs in a portfolio"
...
CODE has:
> Investing Where Vision Meets Venture

Match score: 0.1

## Line 3180 `description`
DOC says:
...
## Line 3186 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Invest in companies before they list on exchanges.
...
## Line 3191 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Capture value creation during the private phase.

Match score: 0.143

## Line 3196 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Exposure to new-age sectors.
...
CODE has:
> What happens if the company gets listed (IPO)"
...
## Line 3248 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Estimates the amount needed for your desired lifestyle.

Match score: 0.167

## Line 3253 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Creates a reliable post-retirement income stream.
...
## Line 3263 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Optimizes returns and manage risks effectively.

Match score: 0.154

## Line 3269 `answer`
DOC says:
> Yes, often rent agreements may include escalation clauses, property values tend to rise with inflation. So, REITs can act as a partial inflation hedge.
...
CODE has:
> Renewable & Future Assets

Match score: 0.1

## Line 3320 `description`
DOC says:
> No matching website-copy line found in DOCX
...
## Line 3348 `question`
DOC says:
> How are these plans different from ULIPs or Mutual Funds?
...
## Line 3374 `description`
DOC says:
> 4. Goal-Based Planning: Align your investments with life goals like retirement, education and wealth creation.
...
CODE has:
> Own Premium Assets Fractionally

Match score: 0.125

## Line 3392 `description`
DOC says:
> No matching website-copy line found in DOCX
...
CODE has:
> Elevating Fixed Income with Thoughtful Innovation

Match score: 0.286

## Line 3433 `description`
DOC says:
...
## Line 3439 `description`
DOC says:
> What returns can I expect from Fractional Investment?

CODE has:
> Returns typically ranging from 10-12%.

Match score: 0.182

## Line 3444 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Spread risk across hundreds of borrowers.

Match score: 0.111

## Line 3449 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Options for regular monthly payouts.
...
CODE has:
> Transparent & Monitored Process

Match score: 0.167

## Line 3454 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Track performance with clarity and ongoing oversight.
...
CODE has:
> When Smart Innovation Meets Predictable Returns

Match score: 0.111

## Line 3494 `description`
DOC says:
...
## Line 3543 `answer`
DOC says:
> 3. Can I add or remove vehicles from the policy?Yes, Fleet Insurance policies offer flexibility to add or remove vehicles during the policy tenure.
...
CODE has:
> Combining Familiar Stability with Enhanced Yield

Match score: 0.125

## Line 3562 `description`
DOC says:
> For many investors, Fixed Deposits (FDs) have long signified financial prudence. Yet Traditional bank FDs often underperform inflation. Corporate FDRs offer a refined alternative—delivering higher yields through reputable NBFCs and corporates, backed by rigorous credit ratings.
...
## Line 3568 `description`
DOC says:
> 2. Is SWP better than Fixed Deposits?

CODE has:
> Better returns than traditional bank deposits.
...
## Line 3573 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Focus on AAA/AA rated issuers.
...
## Line 3593 `question`
DOC says:
> 42) Corporate FDRs Tab

CODE has:
> Are Corporate FDRs safe"
...
CODE has:
> Opening Global Doors, Seamlessly Within India

Match score: 0.118

## Line 3623 `description`
DOC says:
...
## Line 3639 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> No PIS hassles or complex foreign compliance.
...
CODE has:
> Global Financial Hub Ecosystem

Match score: 0.167

## Line 3644 `description`
DOC says:
...
CODE has:
> E-Gold lets you build your gold holdings digitally — no safes, no insurance worries, no purity concerns. Buy as little as a gram or as much as your milestones demand, all secured in vaulted assurance and ready for cash redemption or jewellery conversion when your heart desires. It’s tradition, transformed for today, making sure your portfolio shines with both heritage and hassle-free liquidity. FinAsk Value, we help you integrate E-Gold seamlessly into your broader financial goals—whether it’s gifting with grace, saving for a future wedding or simply balancing your asset mix with a timeless hedge. With 24K purity, full transparency and the power of automation through SIPs, E-Gold becomes more than just a commodity—it becomes a modern heirloom in the making, one digital gram at a time.
...
## Line 3691 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> 24K Gold stored in secure vaults.

Match score: 0.167

## Line 3696 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Easy to buy and sell digitally.
...
## Line 3701 `description`
DOC says:
> E-Gold

CODE has:
> Accumulate gold systematically.
...
CODE has:
> Building a Retirement That Honours Your Efforts

Match score: 0.167

## Line 3746 `description`
DOC says:
...
## Line 3757 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> One of the lowest cost investment products globally.
...
## Line 3762 `description`
DOC says:
> 3. Are SIP returns guaranteed?No, returns are market-linked as mutual funds invest in equity, debt or other instruments. However, long-term investing improves the potential for stable returns.

CODE has:
> Option to invest in equity for higher long-term returns.
...
## Line 3767 `description`
DOC says:
> 4. Goal-Based Planning: Align your investments with life goals like retirement, education and wealth creation.

CODE has:
> Align equity and debt exposure with your age and goals.
...
## Line 3778 `answer`
DOC says:
> There are two types: Tier I – A primary retirement account with tax benefits and withdrawal restrictions and Tier II – A voluntary savings account with flexible withdrawals but limited tax benefits.

CODE has:
> There are two types: Tier I – A primary retirement account with tax benefits and withdrawal restrictions. Tier II – A voluntary savings account with flexible withdrawals but limited tax benefits.
...
## Line 3787 `question`
DOC says:
> What is the minimum ticket size for investment in SIF?
...
## Line 3824 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Advanced platforms for easy trading.
...
## Line 3882 `description`
DOC says:
> 2. Wealth ContinuityKeep your remaining funds invested to continue benefiting from market growth.
...
## Line 3894 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Avoid Capital Gains Tax by retaining investments.
...
CODE has:
> Invest More As You Grow, Achieve More With Time.

Match score: 0.167

## Line 3934 `description`
DOC says:
...
## Line 3950 `description`
DOC says:
> 8+ and YEARS OF SERVING FAMILIES - REDUCE THE GAP BETWEEN THEM
...
## Line 3960 `question`
DOC says:
> 4. How is SWP different from SIP?
...
## Line 3961 `answer`
DOC says:
> 1. Regular Income FlowReceive a steady payout at fixed intervals without redeeming your entire investment.
...
CODE has:
> How often can I increase my SIP step-up amount"
...
CODE has:
> Can I stop or modify the step-up feature later"
...
## Line 4044 `answer`
DOC says:
> 3. Can SWP be paused or stopped?
...
CODE has:
> A Gentle Blueprint for Lasting Peace

Match score: 0.154

## Line 4063 `description`
DOC says:
...
## Line 4084 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Helps preserve intentions and values across generations.

Match score: 0.167

## Line 4090 `answer`
DOC says:
> 1. Is it mandatory for businesses?Not legally mandatory, but often required in contracts, tenders and vendor agreements.
...
## Line 4094 `question`
DOC says:
> Do I need a Lawyer while writing my Will?
...
CODE has:
> Wills and trusts hold your intentions, but it’s the executor who ensures they come alive, without delay, dispute or dilution. Our executor services stand as an unwavering hand to manage distributions, settle obligations and uphold your wishes with absolute integrity. So your lifetime of effort becomes a source of harmony, not heartache, for those you leave behind. At FinAsk Value, our executor services go beyond paperwork. We step in with compassion, clarity and complete confidentiality—coordinating with legal, financial and family stakeholders to ensure every step reflects your intent. Whether it’s handling complex assets, addressing cross-border beneficiaries or mediating sensitive transitions, we provide the calm, competent presence your legacy deserves. Because honouring your life’s work shouldn’t be left to chance.
...
CODE has:
> Debt & Obligation Settlement

Match score: 0.071

## Line 4148 `description`
DOC says:
> 4. Financial Safeguard: Protect your business from unexpected compensation payouts and liabilities.
...
CODE has:
> Can a family member act as an executor"

Match score: 0.368

## Line 4189 `description`
DOC says:
...
## Line 4195 `description`
DOC says:
> Protecting Your Practice, Reputation and Peace of Mind

CODE has:
> Verification of titles and documents.
...
## Line 4200 `description`
DOC says:
> 4. Financial Safeguard: Protect your business from unexpected compensation payouts and liabilities.

CODE has:
> Reviewing financial and business agreements.
...
CODE has:
> Future-Ready Tax Strategy

Match score: 0.2

## Line 4269 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Stay ahead of evolving tax laws with proactive planning.
...
CODE has:
> Empowering Clarity, Inspiring Confidence

Match score: 0.111

## Line 4315 `description`
DOC says:
...
## Line 4321 `description`
DOC says:
> 4. Expense Tracking: Monitor and categorize your spending to stay in control of your finances.
...
## Line 4465 `answer`
DOC says:
> 1. How does the interest-free period work?Most credit cards offer an interest-free period (typically 20–50 days) if you pay the full outstanding amount by the due date.
...
## Line 4499 `tagline`
DOC says:
> Because Progress Should Not Just Be Admired — It Should Be Owned
...
CODE has:
> Family Asset Protection in India

Match score: 0.222

## Line 4525 `description`
DOC says:
> No matching website-copy line found in DOCX
...
CODE has:
> Because She Needs More Than Advice. She Needs Advocacy.

Match score: 0.231

## Line 4566 `description`
DOC says:
...
CODE has:
> Income Continuity Awareness

Match score: 0.2

## Line 4578 `description`
DOC says:
> No matching website-copy line found in DOCX
...
CODE has:
> Holistic Life-Centric Planning

Match score: 0.143

## Line 4584 `description`
DOC says:
> No matching website-copy line found in DOCX
...
CODE has:
> Legacy & Inheritance Planning Support

Match score: 0.095

## Line 4589 `description`
DOC says:
> No matching website-copy line found in DOCX
...
## Line 4600 `question`
DOC says:
> Can you help with Startup Incorporation?

CODE has:
> I have no financial knowledge, can you help"
...
## Line 4605 `question`
DOC says:
> Do you help with Income Tax Returns?

CODE has:
> Do you help with divorce settlements"
...
## Line 4611 `answer`
DOC says:
> Security and Peace of Mind For Your Most Valuable Space
...
## Line 4648 `description`
DOC says:
> No matching website-copy line found in DOCX

CODE has:
> Concierge services for family needs.
...
## Line 4669 `question`
DOC says:
> In Business, Logistics Is More Than Movement — It’s A Promise
...
CODE has:
> Do you handle non-financial assets"
