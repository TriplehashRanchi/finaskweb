      ...
      <div className="container mx-auto px-4 max-w-4xl py-16">
        ...
        <div className="space-y-6 text-lg leading-relaxed text-justify opacity-90">
            ...
            <ul className="list-disc pl-5 space-y-4 ">
                <li>FinAsk Value acts as a Tax Advisor and Financial Product Distributor and does not provide investment advisory services unless separately registered and contractually agreed.</li>
                ...
                <li>Insurance products are governed by applicable policy terms and regulatory guidelines.</li>
                <li>FinAsk Value shall not be responsible for any loss arising from reliance on the information provided on this website.</li>
            </ul>
        </div>
      </div>
      <Footer />
