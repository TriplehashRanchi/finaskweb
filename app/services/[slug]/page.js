        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-2/3">
            ...
            <h2 className="font-serif text-3xl md:text-4xl text-slate-900 mb-6">
              Expert Guidance for{" "}
              <span className="text-[#b08d55]">{service.title}</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              {service.features &&
                service.features.map((feature, idx) => (
                  <div
                    key={idx}
                    className="bg-white p-8 rounded-[1rem] border border-slate-200     transition-all group relative overflow-hidden h-full flex flex-col justify-between min-h-[240px]"
                  >
              ...
              {service.features && service.features.length < 3 && (
                <div className="bg-white p-8 rounded-[1rem] border border-slate-200   transition-all group relative overflow-hidden h-full flex flex-col justify-between min-h-[240px]">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-slate-500 leading-relaxed text-sm">
                      Our dedicated team is always available to guide you
                  ...
                  {service.faq.map((item, idx) => (
                    ...
                    >
                      ...
                      >
                        {/* Icon */}
                        <div
                          className={`mt-1 w-6 h-6 rounded-full flex items-center justify-center shrink-0 transition-colors duration-300 ${
                            openFaqIndex === idx
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 text-[#b08d55] font-bold hover:gap-4 transition-all"
            >
