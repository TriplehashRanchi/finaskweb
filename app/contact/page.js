...
import ScheduleCallTrigger from "@/components/ScheduleCallTrigger";
import { buildMetadata } from "@/lib/seo";

export const metadata = buildMetadata({
  title: "Contact Us",
  description:
    "Get in touch with FinAsk Value. Schedule a call, chat with us on WhatsApp, or reach our Gurugram and Delhi offices directly.",
  path: "/contact",
});
