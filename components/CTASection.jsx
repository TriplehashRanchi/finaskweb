...
export default function CTASection() {
  return (
    <section className="relative w-full py-20 px-4 md:px-8 bg-[#001F2B] overflow-hidden mb-14">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-[#001F2B] via-[#001F2B]/90 to-transparent z-0" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="text-center md:text-left  ">
          ...
          <p className="text-gray-400 text-lg leading-[1.6] capitalize max-w-lg mx-auto md:mx-0">
