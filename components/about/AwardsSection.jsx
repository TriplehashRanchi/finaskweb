      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          {[1, 2, 3, 4].map((item) => (
            <div
              key={item}
              className="aspect-[4/3] bg-white   rounded-lg flex flex-col items-center justify-center hover:shadow-xl transition-all hover:-translate-y-2 group"
            >
              ...
              <span className="text-slate-800 font-bold font-serif">
                Award {item}
              </span>
        ...
        <div className="mt-12 p-6 bg-gray-50 rounded-lg inline-block border border-gray-100">
          <p className="text-gray-500 italic">
            Our recognition is not just for performance—but for the impact we’ve
            created in the lives we manage.
          </p>
        </div>
      </div>
    </section>
