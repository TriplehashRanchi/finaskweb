export const servicesData = [
    ...
    faq: [
      {
        ...
        answer:
          "It typically ranges from 2 to 4 years depending on the policy, though some plans offer shorter waiting periods.",
      },
      {
        question: "Can I port my existing policy?",
        answer:
          "Yes, portability is allowed under IRDAI guidelines without losing benefits like waiting period credits.",
      },
      {
        question: "Does it cover cashless treatment?",
        answer:
    ...
    faq: [
      {
        ...
        answer:
          "Yes, Third Party liability insurance is mandatory by law in India. Comprehensive cover is optional but recommended.",
      },
      {
        question: "What is IDV?",
        answer:
          "Insured Declared Value (IDV) is the maximum sum assured fixed at the start of the policy, representing the current market value of the vehicle.",
      },
      {
        question: "What is a Zero Depreciation cover?",
        answer:
          "It ensures you get the full claim amount without deductions for depreciation on replaced parts (plastic, rubber, glass, etc.).",
      },
      {
        question: "Does it cover engine damage?",
        answer:
  ...
  },
  {
    ...
    description:
      "Exploring the world — be it for business negotiations in London or leisurely summers in the Bahamas — brings unparalleled joy. Yet travel also carries the occasional turbulence: misplaced luggage, unexpected illness, or sudden disruptions. With finely attuned global coverage, we ensure these inconveniences never escalate into financial or emotional burdens. Your plans proceed unhindered, your mind stays uncluttered. From emergency evacuations to hotel cancellations, we safeguard every leg of your itinerary.",
    features: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Most modern travel insurance plans now include coverage for COVID-19 related hospitalization and trip cancellations.",
      },
      {
        question: "What if I lose my passport?",
        answer:
          "The policy covers the cost of obtaining a duplicate or new passport if lost while abroad.",
      },
      {
        question: "Is travel insurance mandatory for all countries?",
        answer:
  ...
  },
  {
    ...
    faq: [
      {
        question: "Does it cover pre-existing diseases?",
        answer:
          "Yes, subject to the waiting period terms of the policy, similar to standard health insurance.",
      },
      {
        question: "What is a deductible?",
        answer:
          "A deductible is the initial amount of the claim that you (or your base policy) must pay before the Super Top-up plan kicks in.",
      },
      {
        question: "Can I use it without a base policy?",
        answer:
  ...
  },
  {
    ...
    faq: [
      {
        question: "Is this covered in health insurance?",
        answer:
          "Usually no. Standard health insurance covers hospitalization costs, while Personal Accident covers disability compensation and death benefits.",
      },
      {
        question: "Does it cover natural death?",
        answer:
          "No, Personal Accident insurance only covers death or disability resulting directly from an accident.",
      },
      {
        question: "What is Temporary Total Disability (TTD)?",
        answer:
          "It covers temporary inability to work (e.g., fractures) and provides a weekly cash benefit for a specified period.",
      },
    ],
    bgImage: "/hero4.jpg",
    introText:
  ...
  },
  {
    ...
    faq: [
      {
        question: "Do I need bills to claim?",
        answer:
          "No, the payout is a fixed lump sum based on the diagnosis of a listed illness, irrespective of actual medical expenses.",
      },
      {
        question: "Can I claim for multiple illnesses?",
        answer:
          "Usually, the policy terminates after the full sum insured is paid out for a critical illness claim.",
      },
      {
        question: "What is the survival period?",
        answer:
          "Most policies require the insured to survive for a specific period (e.g., 30 days) after diagnosis to be eligible for the claim.",
      },
    ],
    bgImage: "/hero1.jpg",
    introText:
  ...
  },
  {
    ...
    faq: [
      {
        question: "Is property insurance expensive?",
        answer:
          "No, it is surprisingly affordable, often costing a fraction of a percent of the property's value.",
      },
      {
        question: "Does it cover the land value?",
        answer:
          "No, property insurance covers the cost of the structure (construction cost). Land value is not insurable as it doesn't depreciate or get destroyed by fire.",
      },
      {
        question: "Can tenants buy property insurance?",
        answer:
          "Tenants can insure the contents (furniture, appliances) belonging to them, but the structure is usually insured by the owner.",
      },
      {
        question: "Does it cover water damage?",
        answer:
          "It covers damage from bursting of water tanks or pipes, but usually excludes gradual seepage or leakage.",
      },
    ],
    bgImage: "/home.jpg",
    introText:
  ...
  },
  {
    ...
    description:
      "In a world where a single click can compromise years of reputation and revenue, cyber insurance stands guard. It shields you from financial losses arising from hacks, data theft, ransomware, or even inadvertent breaches. So you can innovate, operate, and connect fearlessly — knowing that if the unexpected strikes, your business resilience is already insured.",
    features: [
      {
    ...
    faq: [
      {
        question: "Is it only for IT companies?",
        answer:
          "No, any business that handles digital data, customer records, or uses email/internet needs cyber insurance.",
      },
      {
        question: "Does it cover ransomware payments?",
        answer:
          "Yes, many comprehensive policies cover the cost of ransom payments (where legal) and the negotiation process.",
      },
      {
        question: "What is 'Phishing' cover?",
        answer:
          "It covers losses resulting from employees falling victim to phishing emails that lead to data breaches or fund transfers.",
      },
      {
        question: "Does it cover regulatory fines?",
        answer:
          "Yes, it can cover defense costs and fines (where insurable by law) related to data protection regulations like GDPR or DPDP.",
      },
    ],
    bgImage: "/hero3.png",
    introText:
  ...
  },
  {
    ...
    faq: [
      {
        question: "Who can be a Keyman?",
        answer:
          "Any employee with specialized skills, significant contribution to profits, or whose loss would severely impact the business (e.g., CEO, CTO, Top Salesperson).",
      },
      {
        question: "Is the premium tax-deductible?",
        answer:
          "Yes, premiums paid by the company are generally treated as a business expense under Section 37(1) of the Income Tax Act.",
      },
      {
        question: "Who receives the death benefit?",
        answer:
          "The company receives the death benefit, which can be used to stabilize the business, pay off debts, or find a replacement.",
      },
      {
        question: "Is the maturity amount taxable?",
        answer:
          "Yes, the maturity proceeds are taxable in the hands of the company.",
      },
    ],
    bgImage: "/hero4.jpg",
    introText:
    ...
    faq: [
      {
        ...
        answer:
          "Systematic Investment Plan (SIP) allows you to invest small amounts regularly (e.g., monthly) to build wealth over time.",
      },
      {
        question: "What is the difference between Direct and Regular plans?",
        answer:
          "Direct plans have lower expense ratios as they don't involve distributor commissions, leading to slightly higher returns.",
      },
      {
        question: "Are mutual funds safe?",
        answer:
          "They are subject to market risks, but they are regulated by SEBI and offer diversification to mitigate individual stock risk.",
      },
      {
        question: "What is an ELSS fund?",
        answer:
          "Equity Linked Savings Scheme (ELSS) is a tax-saving mutual fund with a 3-year lock-in period, eligible for 80C deduction.",
      },
    ],
    bgImage: "/goal1.png",
    introText:
    ...
    faq: [
      {
        ...
        answer:
          "The minimum investment for PMS is ₹50 Lakhs as per SEBI regulations.",
      },
      {
        question: "How is it different from Mutual Funds?",
        answer:
          "PMS offers a more concentrated portfolio, direct ownership of stocks, and greater flexibility in strategy compared to mutual funds.",
      },
      {
        question: "What are the fees?",
        answer:
          "Fees typically include a fixed management fee (1-2.5%) and/or a performance fee (profit sharing above a hurdle rate).",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "HNIs, family offices, and institutional investors with a minimum ticket size of ₹1 Crore.",
      },
      {
        question: "What are the categories of AIF?",
        answer:
          "Category I (Startups/Social), Category II (Private Equity/Debt), and Category III (Hedge Funds/Public Equities).",
      },
      {
        question: "What is the lock-in period?",
        answer:
          "Cat I and II are close-ended funds with a typical tenure of 3-7 years. Cat III can be open or close-ended.",
      },
      {
  ...
  },
  {
    ...
    description:
      "In a world that often rewards speed and speculation, some investors prefer the quiet dignity of certainty. Bonds offer precisely this—capital preservation paired with predictable income, creating a foundation upon which aspirations can securely rest. Navigating thousands of bond issuances requires more than a glance at yield tables. We evaluate credit histories, macro-economic overlays, and your personal liquidity map to curate options that serve both immediate and intergenerational needs.",
    features: [
      {
    ...
    faq: [
      {
        question: "Are they tax-free?",
        answer:
          "Some bonds like RBI Tax Free bonds are, but most corporate bonds are taxable at your slab rate.",
      },
      {
        question: "What is the risk in bonds?",
        answer:
          "The main risks are Credit Risk (issuer default) and Interest Rate Risk (bond prices fall when rates rise).",
      },
      {
        question: "What are Sovereign Gold Bonds (SGB)?",
        answer:
          "SGBs are government securities denominated in grams of gold. They offer interest (2.5%) plus capital appreciation linked to gold prices.",
      },
      {
        question: "Can I sell bonds before maturity?",
        answer:
    ...
    faq: [
      {
        question: "Is it risky?",
        answer:
          "Yes, unlisted equity has higher risk due to lower liquidity, lack of public information, and regulatory uncertainty.",
      },
      {
        question: "How do I sell unlisted shares?",
        answer:
          "You can sell them in the off-market through specialized dealers or platforms, but finding a buyer can sometimes take time.",
      },
      {
        question: "What is the minimum investment?",
        answer:
          "It varies by opportunity, but typically starts from ₹50,000 to ₹1 Lakh per lot.",
      },
      {
        question: "How are gains taxed?",
        answer:
          "Long Term Capital Gains (>24 months) are taxed at 12.5% (without indexation). Short Term is added to income.",
      },
    ],
    bgImage: "/goal5.png",
    introText:
    ...
    faq: [
      {
        ...
        answer:
          "Yes, generally until the age of 60. However, partial withdrawals are allowed for specific reasons (illness, education, housing) after 3 years.",
      },
      {
        question: "What are the tax benefits?",
        answer:
          "You get deduction up to ₹1.5L under 80C plus an additional ₹50,000 under 80CCD(1B). 60% of the maturity corpus is tax-free.",
      },
      {
        question: "Can I choose my asset allocation?",
        answer:
          "Yes, under 'Active Choice' you can decide the split between Equity (up to 75%), Corporate Bonds, and Govt Securities.",
      },
      {
        question: "What is the annuity requirement?",
        answer:
  ...
  },
  {
    ...
    faq: [
      {
        question: "Do you offer tips?",
        answer:
          "We offer research-based advice and fundamental analysis, not speculative tips or 'hot stock' recommendations.",
      },
      {
        question: "What is Demat account?",
        answer:
          "A Demat (Dematerialized) account holds your shares in electronic format, which is mandatory for trading in Indian stock markets.",
      },
      {
        question: "Can I trade in derivatives (F&O)?",
        answer:
          "Yes, we provide access to Futures & Options trading for hedging or speculation, subject to risk profiling.",
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          "Yes, P2P lending platforms are regulated by the Reserve Bank of India (RBI) as NBFC-P2P.",
      },
      {
        question: "What is the risk of default?",
        answer:
          "There is a risk that borrowers may default. We mitigate this by diversifying your investment across hundreds of borrowers.",
      },
      {
        question: "Are returns guaranteed?",
        answer:
          "No, returns are not guaranteed, but historical data shows stable returns of 10-12% for diversified portfolios.",
      },
      {
    ...
    faq: [
      {
        question: "Is it safe?",
        answer:
          "Corporate FDs are unsecured, so safety depends on the issuer. We recommend only AAA or AA rated deposits for high safety.",
      },
      {
        question: "Is it covered by DICGC insurance?",
        answer:
          "No, corporate FDs are NOT covered by the ₹5 Lakh DICGC insurance that applies to bank deposits.",
      },
      {
        question: "Can I withdraw prematurely?",
        answer:
          "Yes, but there is usually a lock-in period (e.g., 3 months) and a penalty on the interest rate for premature withdrawal.",
      },
      {
        question: "How is interest taxed?",
        answer:
    ...
    faq: [
      {
        ...
        answer:
          "Risks vary by product. Invoice discounting carries credit risk of the anchor corporate. MLDs carry market risk but often have principal protection.",
      },
      {
        question: "What is Invoice Discounting?",
        answer:
          "It involves funding the unpaid invoices of blue-chip companies for a short tenure (30-90 days) in exchange for a return.",
      },
      {
        question: "Are MLD returns tax-efficient?",
        answer:
          "Listed Market Linked Debentures (MLDs) held for >1 year were previously taxed at 10%, but recent rules tax them at slab rates. Check current laws.",
      },
      {
  ...
  },
  {
    ...
    faq: [
      {
        question: "How are they different from REITs?",
        answer:
          "InvITs own infrastructure assets like roads, power grids, and pipelines, while REITs own real estate like offices and malls.",
      },
      {
        question: "What is the minimum investment?",
        answer:
          "For publicly listed InvITs, the minimum lot size is usually small (e.g., 1 unit), making it accessible to retail investors.",
      },
      {
        question: "Are returns guaranteed?",
        answer:
          "No, but they generally offer stable and predictable cash flows due to long-term concession agreements.",
      },
      {
        question: "Is it tax-free?",
        answer:
          "Interest income from InvITs is taxable, but dividend income may be tax-exempt in certain cases.",
      },
    ],
    bgImage: "/hero3.png",
    introText:
  ...
  },
  {
    ...
    faq: [
      {
        question: "Can I convert to physical gold?",
        answer:
          "Yes, many providers offer delivery of physical coins/bars upon request, subject to making charges.",
      },
      {
        question: "Is it safe?",
        answer:
          "Yes, the digital gold is backed by physical gold stored in insured, secure vaults.",
      },
      {
        question: "What is the purity?",
        answer: "E-Gold is typically 24 Karat (99.5% or 99.9% purity).",
      },
      {
        question: "Is there GST?",
        answer:
  ...
  },
  {
    ...
    description:
      "Your wealth is far more than numbers on a balance sheet. It embodies years of perseverance, decisions made for loved ones, and dreams carefully nurtured. Estate planning is the art of preserving this story. At FinAsk, estate planning goes well beyond a simple will. We build an integrated approach that could include trusts, nominee audits, tax-optimized succession plans, and even continuity strategies for businesses or inherited properties.",
    features: [
      {
  ...
  },
  {
    ...
    tagline:
      "Turning that dream into reality without jeopardizing your financial well-being.",
    description:
      "A home is not just a roof over your head. It’s a promise of belonging, a symbol of stability, and often, the most personal investment you’ll ever make. At FinAsk, we craft tailored investment strategies that help you afford your dream home—comfortably and confidently. Whether it’s planning a down payment without liquidating your long-term assets, understanding how much EMI your life stage truly allows, or accounting for the less-spoken costs, we map out every layer.",
    features: [
      {
  ...
  },
  {
    ...
    description:
      "Wills and trusts hold your intentions, but it’s the executor who ensures they come alive, without delay, dispute, or dilution. Our executor services stand as an unwavering hand to manage distributions, settle obligations, and uphold your wishes with absolute integrity. At FinAsk, our executor services go beyond paperwork. We step in with compassion, clarity, and complete confidentiality—coordinating with legal, financial, and family stakeholders to ensure every step reflects your intent.",
    features: [
      {
